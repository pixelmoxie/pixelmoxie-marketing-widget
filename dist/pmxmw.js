...
(function() {
  ...
  PMXMW.WidgetView = (function(superClass) {
    ...
    WidgetView.prototype.initialize = function() {
      ...
      this.dataURL = "https://cdn.rawgit.com/pixelmoxie/pixelmoxie-marketing-widget/7b578d6/dist/data.xml";
    ...
    WidgetView.prototype.setupView = function() {
      ...
      this.$tabs = $('.pmxWidgetModal-trigger');
      this.$viewport = $('.pmxWidgetModal-viewport');
      this.$content = $('.pmxWidgetModal-content');
      this.$panels = $('.pmxWidgetModal-section');
